...
public class InstanceUserTaskListViewController extends AbstractInstanceViewController {
	...
	@Transactional
	public String UserTasksList(@PathVariable("key") final long key, final Map<String, Object> model,
	...
	@Override
	protected void fillViewDetailsIntoDto(ProcessInstanceEntity instance, List<ElementInstanceEntity> events,
			List<IncidentEntity> incidents, Map<Long, String> elementIdsForKeys, Map<String, Object> model, Pageable pageable,
			ProcessInstanceDto dto) {
		final List<UserTaskEntity> userTasks = userTaskRepository
				.findByProcessInstanceKeyOrderByStartAscKeyAsc(instance.getKey(), pageable);
