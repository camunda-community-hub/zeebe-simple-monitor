...
/**
 * This test will not run unless TEST_MYSQL=true is specified.
 */
public class SimpleMonitorExporterTestMysql {
  ...
  @Before
  public void setup() {
    org.junit.Assume.assumeTrue("true".equals(System.getenv("TEST_MYSQL")));

    exporter = new SimpleMonitorExporter();
    configuration = new SimpleMonitorExporterConfiguration();
    configuration.jdbcUrl = env("SIMPLE_MONITOR_EXPORTER_JDBC_URL", "jdbc:mariadb://localhost:3306/zeebe");
    configuration.driverName = env("\"SIMPLE_MONITOR_EXPORTER_JDBC_DRIVER", "org.mariadb.jdbc.Driver");
    configuration.userName = env("SIMPLE_MONITOR_EXPORTER_JDBC_USER", "zeebe");
    configuration.password = env("SIMPLE_MONITOR_EXPORTER_JDBC_PASSWORD", "123");
    configuration.createSchema = "/CREATE_SCHEMA_MYSQL.sql";
  ...
  private String env(String name, String def) {
